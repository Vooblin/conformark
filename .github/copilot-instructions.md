...
**Before writing code:**
1. Run `cargo test -- --nocapture` to see current coverage (48.4% baseline - 317/655 tests passing)
...
# Run all tests including 655 spec tests (currently 317 passing, 48.4% coverage)
cargo test --verbose
...
4. **Track progress**: Coverage % increases as features are added (currently 48.4%)
...
The majority of current failures (338/655 tests) fall into these categories:
