...
**Before writing code:**
1. Run `cargo test -- --nocapture` to see current coverage (48.1% baseline - 315/655 tests passing)
...
4. **Track progress**: Coverage % increases as features are added (currently 48.1%)
...
The majority of current failures (340/655 tests) fall into these categories:
