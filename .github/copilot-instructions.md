...
**Before writing code:**
1. Run `cargo test -- --nocapture` to see current coverage (50.1% baseline - 328/655 tests passing)
...
# Run all tests including 655 spec tests (currently 328 passing, 50.1% coverage)
cargo test --verbose
...
4. **Track progress**: Coverage % increases as features are added (currently 50.1%)
...
The majority of current failures (327/655 tests) fall into these categories:
